...
func readAlertRule(r io.Reader) (*AlertRule, error) {
	var str = &AlertRule{}
	var err error
	...
	str.CreationTime, err = readLong(r)
	if err != nil {
		return nil, err
	}
...
func writeAlertRule(r *AlertRule, w io.Writer) error {
	var err error
	...
	err = writeLong(r.CreationTime, w)
	if err != nil {
		return err
	}
